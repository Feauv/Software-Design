...
/**
 * Server is class that acts as a driver for {@link DataGenerator}
 */
public class Server {

    /**
     * Number of {@link Request} Types
     */
    private static final Integer NUM_REQ_TYPES = 9;

    /**
     * The main method constructs for all {@link Request} classes and put them into a stack. Uses the {@link DataGenerator}
     * inside a switch statement, inside a for loop to generate every possible type of {@link Request}. Also prints out
     * the counts for each.
     *
     * @param args
     */
    public static void main(String args[]){
        ...
        while (!requestStack.isEmpty()) {
            ...
            System.out.println(req.instanceVariables() + "\n");
        }
